...
class GeoNamesQueryDialog(QDialog):
	...
	def __init__(self, parent=None):
		...
		searchButton.clicked.connect(self.searchEvent)
	...
	def searchEvent(self):
		tr = self.tr
		txt = str(self.nameQuery.text()).strip()
		if txt == '': # no input
			self.selectButton.setDisabled(True)
		...
		th.finished.connect(progDialog.accept)
		progDialog.rejected.connect(th.quit)
		th.start()
		ok = progDialog.exec_()
