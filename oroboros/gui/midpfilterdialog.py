...
class MidPointsFilterDialog(QDialog):
	...
	def __init__(self, parent=None, filt=None):
		...
		mppfButton.clicked.connect(self.editPlanetsFilter)
		...
		mpafButton.clicked.connect(self.editAspectsFilter)
		...
		mpofButton.clicked.connect(self.editOrbsFilter)
		...
		mparButton.clicked.connect(self.editAspectsRestrictions)
		...
		mporButton.clicked.connect(self.editOrbsRestrictions)
