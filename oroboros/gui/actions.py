...
def createActions(self):
	...
	self.actionNewMultiChart.triggered.connect(
	...
	self.actionHereNowMultiChart.triggered.connect(
	...
	self.actionOpenMultiChart.triggered.connect(
	...
	self.actionOpenMultiChartA32.triggered.connect(
	...
	self.actionOpenMultiChartSkif.triggered.connect(
	...
	self.actionCustomMultiChart.triggered.connect(
	...
	self.actionCloseMultiChart.triggered.connect(
	...
	self.actionFilters.triggered.connect(
	...
	self.actionPlanetsFilters.triggered.connect(
	...
	self.actionAspectsFilters.triggered.connect(
	...
	self.actionOrbsFilters.triggered.connect(
	...
	self.actionAspectsRestrictions.triggered.connect(
	...
	self.actionOrbsRestrictions.triggered.connect(
	...
	self.actionMidPointsFilters.triggered.connect(
	...
	self.actionOpenChart1.triggered.connect(
	...
	self.actionOpenChart2.triggered.connect(
	...
	self.actionHideChart1.triggered.connect(
	...
	self.actionHideChart2.triggered.connect(
	...
	self.actionEditChart1.triggered.connect(
	...
	self.actionEditChart2.triggered.connect(
	...
	self.actionFilterChart1.triggered.connect(
	...
	self.actionFilterChart2.triggered.connect(
	...
	self.actionSaveChart1.triggered.connect(
	...
	self.actionSaveChart2.triggered.connect(
	...
	self.actionSaveChart1As.triggered.connect(
	...
	self.actionSaveChart2As.triggered.connect(
	...
	self.actionCloseChart1.triggered.connect(
	...
	self.actionCloseChart2.triggered.connect(
	...
	self.actionSwitchCharts.triggered.connect(
	...
	self.actionTransitMode.triggered.connect(
	...
	self.actionProgressionMode.triggered.connect(
	...
	self.actionDirectionMode.triggered.connect(
	...
	self.actionMultiplyPos.triggered.connect(
	...
	self.actionAddPos.triggered.connect(
		self.addPosEvent)
	...
	self.actionComposite.triggered.connect(
		self.compositeEvent)
	...
	self.actionMidSpaceTime.triggered.connect(
	...
	self.actionAboutOroboros.triggered.connect(
