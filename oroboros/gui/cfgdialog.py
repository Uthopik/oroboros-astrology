...
class CfgDialog(QDialog):
	...
	def accept(self):
		# ### main ###
		# username
		cfg.username = str(self.usernameEdit.text())
		# usermail
		cfg.usermail = str(self.usermailEdit.text())
		# language
		...
		cfg.language = lng
		# charts dir
		cfg.charts_dir = str(self.chartsdirEdit.text())
		# use docutils
		cfg.use_docutils = self.useDocutilsBox.isChecked()
		# ### default chart ###
		# location
		cfg.dft_location = str(self.locationEdit.text())
		# country
		cfg.dft_country = str(self.countryEdit.text())
		# zoneinfo
		...
		# hg repo
		cfg.hg_repo = str(self.hgRepoEdit.text())
		# hg user
		cfg.hg_user = str(self.hgUserEdit.text())
		# hg pswd
		cfg.hg_pswd = str(self.hgPswdEdit.text())
