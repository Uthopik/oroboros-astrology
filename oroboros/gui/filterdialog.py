...
class FilterDialog(QDialog):
	...
	def __init__(self, parent=None, filt=None):
		...
		selectButton.clicked.connect(self.ephePathSelect)
		...
		pfButton.clicked.connect(self.editPlanetsFilter)
		...
		afButton.clicked.connect(self.editAspectsFilter)
		...
		ofButton.clicked.connect(self.editOrbsFilter)
		...
		arButton.clicked.connect(self.editAspectsRestrictions)
		...
		self.draw_midpEdit.stateChanged.connect(
		...
		mpButton.clicked.connect(self.editMidPointsFilter)
	...
	def accept(self):
		...
		if ephetype == 0:
			...
			ephetype = 'moshier'
		# ephe path
		ephepath = str(self.ephepathEdit.text())
		# hsys
